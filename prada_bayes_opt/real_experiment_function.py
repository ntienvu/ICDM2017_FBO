...
class Robot_BipedWalker:
    ...
    def run_BipedWalker(self,X):
        ...
        import matlab
        eng = matlab.engine.start_matlab()
        eng.addpath(r'P:\03.Research\05.BayesianOptimization\RealExperiments\WGCCM_three_link_walker_example\WGCCM_three_link_walker_example',nargout=0)
...
class BayesNonMultilabelClassification:
    ...
    def run_BNMC(self,X):
        ...
        import matlab
        eng = matlab.engine.start_matlab()
        eng.addpath(r'P:\03.Research\05.BayesianOptimization\PradaBayesianOptimization\run_experiment_unbounded\BNMC',nargout=0)
        eng.addpath(r'P:\03.Research\05.BayesianOptimization\PradaBayesianOptimization\run_experiment_unbounded\BNMC\utilities',nargout=0)
        eng.addpath(r'P:\03.Research\05.BayesianOptimization\PradaBayesianOptimization\run_experiment_unbounded\BNMC\data',nargout=0)
